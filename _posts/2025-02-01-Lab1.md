...
<p align="center">
<img src="../assets/img/lab1/prelab_config.png" alt="drawing" width="100%">
</p>
...
<p align="center">
<img src="../assets/img/lab1/echo_python.png" alt="drawing" width="100%">
</p>

The serial terminal on the Arduino IDE also prints the message that it sends to the computer:
<p align="center">
<img src="../assets/img/lab1/echo_arduino.png" alt="drawing" width="100%">
</p>
...
<p align="center">
<img src="../assets/img/lab1/send_three_floats.png" alt="drawing" width="100%">
</p>
...
<p align="center">
<img src="../assets/img/lab1/get_time_millis.png" alt="drawing" width="100%">
</p>
...
<p align="center">
<img src="../assets/img/lab1/get_time_millis_notif_handler.png" alt="drawing" width="100%">
</p>
...
<p align="center">
<img src="../assets/img/lab1/time_loop.png" alt="drawing" width="100%">
</p>

From this result, we can tell that the effective data transfer rate is

$$
\frac{50 \text{ messages}}{34.819\text{s} - 34.357\text{s}} = 108 \text{ messages/s}
$$
...
<p align="center">
<img src="../assets/img/lab1/send_time_data.png" alt="drawing" width="100%">
</p>
...
<p align="center">
<img src="../assets/img/lab1/get_temp_reading.png" alt="drawing" width="100%">
</p>
